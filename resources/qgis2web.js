...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [5625918.396231, 3016391.291518, 5630092.902499, 3018838.835251], maxZoom: 22, minZoom: 10
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([5625918.396231, 3016391.291518, 5630092.902499, 3018838.835251], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Parcel_numberRIFFA_ALBUHAIR_3,
    colName: 'BSI_str',
    zoom:1000, 
    collapsed: true,
    map: map
...
document.getElementsByClassName('search-layer-input-search')[0].placeholder = 'Search parcel ...';
